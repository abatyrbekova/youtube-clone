...
{D:"div",K:"ytp-mdx-privacy-popup-buttons",U:[{D:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],qa:"\u041e\u0442\u043c\u0435\u043d\u0430"},{D:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],qa:"\u041e\u041a"}]}]}]});this.i=new g.JK(this,250);this.cancelButton=this.Da("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Da("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.S(this.cancelButton,"click",this.j);this.S(this.confirmButton,"click",this.u)},N9=function(a){g.V.call(this,
{D:"div",
...
b=g.U(b,128)?g.dH('\u041e\u0448\u0438\u0431\u043a\u0430 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',c):b.Hc()||g.U(b,4)?g.dH('\u0412\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u0435 \u043d\u0430 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0435 "$RECEIVER_NAME"',c):g.dH('\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u043e \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435 \u043a \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0443 "$RECEIVER_NAME"',
...
this.il={key:f7(),name:"\u042d\u0442\u043e\u0442 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440"};this.gi=null;this.subscriptions=[];this.KG=this.Wb=null;this.So=[this.il];this.Fn=this.il;this.Gd=new g.JI(64);this.xM=0;this.Bf=-1;this.vx=!1;this.sx=this.Mt=null;if(!g.XD(this.player.T())&&!g.YD(this.player.T())){a=this.player;var b=g.TL(a);b&&(b=b.Wn())&&(b=new O9(a,b),g.J(this,b));b=new N9(a);g.J(this,b);g.cM(a,b.element,4);this.Mt=new M9;g.J(this,this.Mt);g.cM(a,this.Mt.element,4);this.vx=
!!w9()}},Q9=function(a){a.sx&&(a.player.removeEventListener("presentingplayerstatechange",a.sx),a.sx=null)},w0a=function(a,b,c){a.Gd=c;
...
break;case -1:this.Xb(new g.JI(64));break;case -1E3:this.Xb(new g.JI(128,{errorCode:"mdx.remoteerror",errorMessage:"\u0412\u0438\u0434\u0435\u043e \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u043e \u0434\u043b\u044f \u0443\u0434\u0430\u043b\u0435\u043d\u043d\u043e\u0433\u043e \u0432\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u044f.",tE:2}))}a=a9(this.Wb).trackData;var b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==
b.languageName&&a.kind==b.kind:1)||(this.B=a,u0a(this,a));a=a9(this.Wb);-1===a.volume||Math.round(this.G.getVolume())===a.volume&&this.G.isMuted()===a.muted||this.W.isActive()||this.FP()}else t0a(this)};
...
O9.prototype.uj=function(a){return"cast-selector-receiver"===a?"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c":this.So[a].name};
