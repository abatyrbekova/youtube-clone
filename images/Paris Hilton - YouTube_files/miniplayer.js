...
g.k.pF=function(){this.tooltip=new g.fQ(this.player,this);g.J(this,this.tooltip);g.cM(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.zc=new g.jN(this.player);g.J(this,this.zc);this.Fg=new g.V({D:"div",K:"ytp-miniplayer-scrim"});g.J(this,this.Fg);this.Fg.Ca(this.element);this.S(this.Fg.element,"click",this.RA);var a=new g.V({D:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],V:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.cK()]});g.J(this,a);a.Ca(this.Fg.element);
this.S(a.element,"click",this.Mi);a=new g.X1(this.player,this);g.J(this,a);a.Ca(this.Fg.element);this.Rp=new g.V({D:"div",K:"ytp-miniplayer-controls"});g.J(this,this.Rp);this.Rp.Ca(this.Fg.element);this.S(this.Rp.element,"click",this.RA);var b=new g.V({D:"div",K:"ytp-miniplayer-button-container"});g.J(this,b);b.Ca(this.Rp.element);a=new g.V({D:"div",K:"ytp-miniplayer-play-button-container"});g.J(this,a);a.Ca(this.Rp.element);var c=new g.V({D:"div",K:"ytp-miniplayer-button-container"});g.J(this,c);
c.Ca(this.Rp.element);this.kO=new g.IO(this.player,this,!1);g.J(this,this.kO);this.kO.Ca(b.element);b=new g.GO(this.player,this);g.J(this,b);b.Ca(a.element);this.nextButton=new g.IO(this.player,this,!0);g.J(this,this.nextButton);this.nextButton.Ca(c.element);this.Ig=new g.SP(this.player,this);g.J(this,this.Ig);this.Ig.Ca(this.Fg.element);this.Ic=new g.QO(this.player,this);g.J(this,this.Ic);g.cM(this.player,this.Ic.element,4);this.HA=new g.V({D:"div",K:"ytp-miniplayer-buttons"});g.J(this,this.HA);
g.cM(this.player,this.HA.element,4);a=new g.V({D:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],V:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.cK()]});g.J(this,a);a.Ca(this.HA.element);this.S(a.element,"click",this.Mi);a=new g.V({D:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],V:{"aria-label":"\u0417\u0430\u043a\u0440\u044b\u0442\u044c"},U:[g.jK()]});g.J(this,a);a.Ca(this.HA.element);this.S(a.element,"click",this.VW);this.S(this.player,"presentingplayerstatechange",
this.Rc);this.S(this.player,"appresize",this.yb);this.S(this.player,"fullscreentoggled",this.yb);this.yb()};
